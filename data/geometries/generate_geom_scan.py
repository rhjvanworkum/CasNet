...
if __name__ == "__main__":
  fulvene_0 = read_xyz_file('/home/ruard/Documents/experiments/fulvene/geometries/old/geom_scan_200/geometry_0.xyz')
  fulvene_1 = read_xyz_file('/home/ruard/Documents/experiments/fulvene/geometries/old/geom_scan_200/geometry_199.xyz')

  geometries = interpolate_geometry(fulvene_0, fulvene_1, 2500)

  for idx, geometry in enumerate(geometries):
    write_xyz_file(geometry, '/home/ruard/Documents/experiments/fulvene/geometries/fulvene_geom_scan_2500/geometry_' + str(idx) + '.xyz')
