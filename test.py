...
for idx in range(25):
  shutil.copy2(src=f'/home/ruard/Documents/experiments/fulvene/geometries/fulvene_md_traj_25/geometry_{idx}.xyz',
               dst=f'/home/ruard/Documents/experiments/fulvene/geometries/fulvene_md_250/geometry_{225 + idx}.xyz')